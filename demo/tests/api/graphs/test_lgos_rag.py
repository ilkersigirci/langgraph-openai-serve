...
def test_loads_a_controlled_markdown_corpus(tmp_path: Path) -> None:
    ...
    documents = lgos_rag_module.load_documents(docs_root)
    ...
    assert [(document.page_content, document.metadata) for document in documents] == [
        (
            "# Guide\n\nBody.",
            {
                ...
                "title": "Guide (docs/guide.md)",
                "url": (
                    "https://github.com/ilkersigirci/langgraph-openai-serve/"
        ...
        (
            "No heading.",
            {
                "source": "docs/nested/reference.md",
                "title": ("docs/nested/reference.md (docs/nested/reference.md)"),
                "url": (
                    "https://github.com/ilkersigirci/langgraph-openai-serve/"
                    "blob/main/docs/nested/reference.md"
                ),
            },
        ),
    ]
...
def test_default_corpus_includes_every_documentation_file() -> None:
