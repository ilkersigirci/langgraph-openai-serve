...
BIFROST_BASE_URL = os.getenv("LGOS_TEST_BIFROST_BASE_URL")
LGOS_BASE_URL = os.getenv("LGOS_TEST_DIRECT_BASE_URL", "http://localhost:8000/v1")

pytestmark = [
    pytest.mark.anyio,
    pytest.mark.skipif(
        BIFROST_BASE_URL is None,
        reason="set LGOS_TEST_BIFROST_BASE_URL to test through Bifrost",
    ),
]
