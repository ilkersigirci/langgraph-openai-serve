...
| [`hosted-tool`](hosted-tool.md) | Explicit server-side custom clock and OpenAI-compatible web search | None | Upstream model plus SearXNG, Degoog, or upstream OpenAI search |
