...
callbacks. Integrations such as Langfuse can use it for in-process
interrupt/resume continuity. LGOS does not set LangChain's native execution
`run_id` or Langfuse's generated trace ID.
